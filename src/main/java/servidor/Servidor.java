...
public class Servidor extends Thread {
	...
	public static String getCadenaPersonajesConectados() {
		String cadenaNombrePersonajesConectados = "";
		for (PaquetePersonaje paquetePersonaje : personajesConectados.values()) {
			cadenaNombrePersonajesConectados += ("\n" + paquetePersonaje.getNombre());
		}
		cadenaNombrePersonajesConectados.replaceFirst("\n", "");
		return cadenaNombrePersonajesConectados;
	}
